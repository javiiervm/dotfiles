...
Singleton {
    ...
    /*property QtObject defaultColors: QtObject {
        ...
        property color m3primary: GlobalTheme.Theme.blue
        property color m3onPrimary: GlobalTheme.Theme.bg0
        property color m3primaryContainer: GlobalTheme.Theme.purple
        property color m3onPrimaryContainer: GlobalTheme.Theme.bg0
        property color m3secondary: GlobalTheme.Theme.green
        property color m3onSecondary: GlobalTheme.Theme.bg0
        property color m3secondaryContainer: GlobalTheme.Theme.notifBg3
        property color m3onSecondaryContainer: GlobalTheme.Theme.fg
        property color m3background: GlobalTheme.Theme.bg0
        property color m3onBackground: GlobalTheme.Theme.fg
        property color m3surface: GlobalTheme.Theme.bg1
        property color m3surfaceContainerLow: GlobalTheme.Theme.notifBg
        property color m3surfaceContainer: GlobalTheme.Theme.notifBgAlt
        property color m3surfaceContainerHigh: GlobalTheme.Theme.notifBgBtn
        property color m3surfaceContainerHighest: GlobalTheme.Theme.notifBg3
        property color m3onSurface: GlobalTheme.Theme.fg
        property color m3surfaceVariant: GlobalTheme.Theme.notifBgBtn
        property color m3onSurfaceVariant: GlobalTheme.Theme.grey1
        property color m3inverseSurface: GlobalTheme.Theme.fg
        property color m3inverseOnSurface: GlobalTheme.Theme.bg0
        property color m3outline: GlobalTheme.Theme.grey1
        property color m3outlineVariant: GlobalTheme.Theme.notifBgBtn
        property color m3shadow: "#000000"
    }*/
    /*property QtObject defaultColors: QtObject {
        property bool darkmode: true
        ...
        property color m3primaryContainer: Theme.purple
        property color m3onPrimaryContainer: Theme.bg0
        
        // Acentos secundarios
        property color m3secondary: Theme.green
        property color m3onSecondary: Theme.bg0
        property color m3secondaryContainer: Theme.notifBg3
        property color m3onSecondaryContainer: Theme.white

        // --- FONDOS GENERALES ---
        property color m3background: Theme.bg0 // Fondo principal de la pantalla
        property color m3onBackground: Theme.white // Color general del texto

        // --- VENTANAS Y ÁREAS DE TRABAJO (Gris claro) ---
        property color m3surface: Theme.notifBg // Gris base para las ventanas
        property color m3surfaceContainerLow: Theme.notifBgAlt 
        property color m3surfaceContainer: Theme.notifBgBtn // Gris intermedio
        property color m3surfaceContainerHigh: Theme.notifBg3 // Gris más claro
        property color m3surfaceContainerHighest: Theme.grey1

        // --- TEXTOS Y NÚMEROS ---
        property color m3onSurface: Theme.white // Números de los workspaces en blanco
        property color m3surfaceVariant: Theme.notifBg3
        property color m3onSurfaceVariant: Theme.fg // Texto secundario

        // --- BORDES Y OTROS ---
        property color m3inverseSurface: Theme.fg
        property color m3inverseOnSurface: Theme.bg0
        property color m3outline: Theme.grey1
        property color m3outlineVariant: Theme.notifBgBtn
        property color m3shadow: "#000000"
    }*/
    property QtObject defaultColors: QtObject {
        property bool darkmode: true
